...
"""
python main_h36m_3d.py --kernel_size 10 --dct_n 20 --input_n 50 --output_n 10 --skip_rate 1 --batch_size 32 --test_batch_size 32 --in_features 66 --dev cuda --lr 0.001
python main_h36m_3d.py --kernel_size 10 --dct_n 35 --input_n 50 --output_n 25 --skip_rate 1 --batch_size 32 --test_batch_size 32 --in_features 66 --dev cuda --lr 0.001
"""
...
def main(opt):
    ...
    if not opt.is_eval:
        ...
        valid_loader = DataLoader(valid_dataset, batch_size=opt.test_batch_size, shuffle=True, num_workers=4,
                                  pin_memory=True)
