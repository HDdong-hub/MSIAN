...
class AttModel(Module):
    ...
    def __init__(self, in_features=66, kernel_size=10, d_model=256, num_stage=2, dct_n=20):
        ...
        self.gcn = GCN.GCN(input_feature=2 * dct_n, hidden_feature=d_model, p_dropout=0.3,
                           num_stage=num_stage,
                           node_n=in_features)


    def forward(self, src, output_n=25, input_n=50, itera=1, dev='cuda:0', dct_n=None):
        """
