...
class Datasets(Dataset):
    ...
    def __init__(self, opt, actions=None, split=0):
        ...
        amass_splits = [
            ['CMU', 'MPI_Limits', 'TotalCapture', 'EyesJapanDataset', 'KIT', 'EKUT', 'TCD_handMocap', 'ACCAD', 'HumanEva',
             'MPI_HDM05', 'SFU', 'MPI_mosh'],
        ...
        # load mean skeleton
        skel = np.load('C:/Users/river/Desktop/paper/one/MANet/body_models/smpl_skeleton.npz')
